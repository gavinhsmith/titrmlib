...
**Version:** `TITRM_VERSION` is `"0.4.2"`. v0.1.0 through v0.4.2 are
released; v0.3.0 added code page 437, v0.4.0 the formatting, v0.4.1 smaller
memory use and v0.4.2 `term_snprintf`.
